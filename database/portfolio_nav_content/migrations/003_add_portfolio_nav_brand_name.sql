-- Nav brand title (React: PORTFOLIO_BRAND.fullName / PortfolioNav brandLabel)
...
COMMENT ON COLUMN portfolio_nav_content.nav_brand_name IS 'React: nav brand — PORTFOLIO_BRAND.fullName';
